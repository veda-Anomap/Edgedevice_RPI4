...
class App(QMainWindow):
    ...
    def on_result(self, detections, latency):
        ...
        for det in detections:
            ...
            if self.check_fall.isChecked():
                res = self.fall_sim.check_fall(bbox, kpts)
    ...
    def draw_detections(self, frame):
        ...
        for det in self.detections:
            ...
            thick = 3 if is_falling else 2
            
            if is_falling: any_fall = True
            ...
            if hasattr(self.ai_thread, 'SKELETON'):
                sk_color = (0, 165, 255) if is_falling else (255, 255, 0) # Orange if fall
        ...
        if any_fall:
            cv2.putText(canvas, "!!! FALL DETECTED !!!", (50, 80), 
